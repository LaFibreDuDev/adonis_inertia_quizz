...
type AuthSigninGetHead = {
  request: unknown
  response: MakeTuyauResponse<import('#auth/controllers/auth_controller').default['signin'], false>
}
type AuthStorePost = {
  request: MakeTuyauRequest<InferInput<(typeof import('#auth/validators/user'))['signinValidator']>>
  response: MakeTuyauResponse<import('#auth/controllers/auth_controller').default['store'], true>
}
type AuthLoginGetHead = {
  request: unknown
  response: MakeTuyauResponse<import('#auth/controllers/auth_controller').default['login'], false>
}
type AuthLoginPost = {
  request: unknown
  response: MakeTuyauResponse<
    import('#auth/controllers/auth_controller').default['processLogin'],
    false
  >
}
type AuthLogoutGetHead = {
  request: unknown
  response: MakeTuyauResponse<import('#auth/controllers/auth_controller').default['logout'], false>
}
type TeacherBlogGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('#teacher/post/controllers/post_controller').default['list'],
    false
  >
}
type TeacherBlogAddGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('#teacher/post/controllers/post_controller').default['add'],
    false
  >
}
type TeacherBlogStorePost = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('#teacher/post/validators/post'))['createPostValidator']>
  >
  response: MakeTuyauResponse<
    import('#teacher/post/controllers/post_controller').default['store'],
    true
  >
}
type TeacherBlogEditIdGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('#teacher/post/controllers/post_controller').default['edit'],
    false
  >
}
type TeacherBlogUpdateIdPut = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('#teacher/post/validators/post'))['editPostValidator']>
  >
  response: MakeTuyauResponse<
    import('#teacher/post/controllers/post_controller').default['update'],
    true
  >
}
type TeacherBlogDestroyIdDelete = {
  request: unknown
  response: MakeTuyauResponse<
    import('#teacher/post/controllers/post_controller').default['destroy'],
    false
  >
}
type TeacherQuizGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/teacher/quiz/controllers/quiz_controller.ts').default['list'],
    false
  >
}
type TeacherQuizShowIdGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/teacher/quiz/controllers/quiz_controller.ts').default['show'],
    false
  >
}
type TeacherQuizAddGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/teacher/quiz/controllers/quiz_controller.ts').default['add'],
    false
  >
}
type TeacherQuizStorePost = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('../app/teacher/quiz/validators/quiz.ts'))['createQuizValidator']>
  >
  response: MakeTuyauResponse<
    import('../app/teacher/quiz/controllers/quiz_controller.ts').default['store'],
    true
  >
}
type TeacherQuizEditIdGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/teacher/quiz/controllers/quiz_controller.ts').default['edit'],
    false
  >
}
type TeacherQuizUpdateIdPut = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('../app/teacher/quiz/validators/quiz.ts'))['editQuizValidator']>
  >
  response: MakeTuyauResponse<
    import('../app/teacher/quiz/controllers/quiz_controller.ts').default['update'],
    true
  >
}
type TeacherQuizDestroyIdDelete = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/teacher/quiz/controllers/quiz_controller.ts').default['destroy'],
    false
  >
}
type TeacherQuestionQuizIdAddGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('#teacher/question/controllers/question_controller').default['add'],
    false
  >
}
type TeacherQuestionStorePost = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('#teacher/question/validators/question'))['createQuestionValidator']>
  >
  response: MakeTuyauResponse<
    import('#teacher/question/controllers/question_controller').default['store'],
    true
  >
}
type TeacherQuestionQuizIdEditGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('#teacher/question/controllers/question_controller').default['edit'],
    false
  >
}
type TeacherQuestionUpdateIdPut = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('#teacher/question/validators/question'))['editQuestionValidator']>
  >
  response: MakeTuyauResponse<
    import('#teacher/question/controllers/question_controller').default['update'],
    true
  >
}
type TeacherQuestionQuizIdDestroyIdDelete = {
  request: unknown
  response: MakeTuyauResponse<
    import('#teacher/question/controllers/question_controller').default['destroy'],
    false
  >
}
type StudentGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('#core/controllers/page_controller').default['studentHome'],
    false
  >
}
type StudentQuizGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('#core/controllers/page_controller').default['studentQuiz'],
    false
  >
}
type StudentAboutGetHead = {
  request: unknown
  response: MakeTuyauResponse<import('#core/controllers/page_controller').default['about'], false>
}
